...
def run_softmax_on_MNIST(temp_parameter=1):
    ...
    y_new=update_y(train_y,test_y)
    test_error=compute_test_error_mod3(test_x, y_new[1], theta, temp_parameter)
    return test_error
...
def run_softmax_on_MNIST_mod3(temp_parameter=1):
    ...
    train_x, train_y, test_x, test_y = get_MNIST_data()
    y_new=update_y(train_y,test_y)
    theta, cost_function_history = softmax_regression(train_x, y_new[0], temp_parameter, alpha=0.3, lambda_factor=1.0e-4, k=10, num_iterations=150)
    test_error=compute_test_error_mod3(test_x, y_new[1], theta, temp_parameter)
    return test_error
    raise NotImplementedError
    
#print('softmax_mod_3 test_error=', run_softmax_on_MNIST_mod3(temp_parameter=1))
